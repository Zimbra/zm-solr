 ...
 * <li>accented character to ASCII equivalent (
 ...
 */
public final class NormalizeCharFilter extends CharFilter {

	public NormalizeCharFilter(Reader in) {
	...
	/**
	 * Other {@code TokenFilter}s may directly use this method without chaining
	 * this filter.
	 */
	public static int normalize(int c) {
		...
		case '\u014A': // [LATIN CAPITAL LETTER ENG]
		...
		case '\u0138': // [LATIN SMALL LETTER KRA]
						// http://en.wikipedia.org/wiki/Kra_(letter)
		...
		case '\u01F7': // [LATIN CAPITAL LETTER WYNN]
		...
		case '\u021C': // [LATIN CAPITAL LETTER YOGH]
		...
		case '\u021D': // [LATIN SMALL LETTER YOGH]
						// http://en.wikipedia.org/wiki/Yogh
	...
	public static String normalize(String value) {
		...
		for (int i = 0; i < value.length(); i++)
			result.append((char) NormalizeCharFilter.normalize(value.charAt(i)));

		return result.toString();
	}

	@Override
	protected int correct(int arg0) {
		return arg0;
	}
}
